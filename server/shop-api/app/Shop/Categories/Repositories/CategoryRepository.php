...
class CategoryRepository extends BaseRepository implements CategoryRepositoryInterface
{
  ...
  public function createCategory(array $params): Category
  {
    try {
      ...
      $thumb = (isset($params['thumb']) && ($params['thumb'] instanceof UploadedFile)) ?
        $this->uploadOne($params['thumb'], 'categories') : '';
      ...
      throw new CategoryInvalidArgumentException($e->getMessage(), 500, $e);
    }
  }
  ...
  public function updateCategory(array $params): Category
  {
    ...
    if (isset($params['thumb']) && ($params['thumb'] instanceof UploadedFile)) {
      $thumb = $this->uploadOne($params['thumb'], 'categories');
    }

    $merge = $thumb != '' ? $collection->merge(compact('slug', 'thumb')) : $collection->merge(compact('slug'));
  ...
  public function findCategoryById(int $id): Category
  {
    try {
      ...
      throw new CategoryNotFoundException($e->getMessage(), 404, $e);
    }
  }
